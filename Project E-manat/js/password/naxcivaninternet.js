...
function Create() {
  ...
  logoPart.style.background = "rgb(161, 158, 158)";
  let logoImg = new createElem("img", "images/naxcivan-internet.png", "logoImg", logoPart);
  logoPart.style.position = "relative";
  logoImg.style.width = "30%";
  logoImg.style.height = "50%";
  logoImg.style.marginTop = "0px";
  logoImg.style.marginBottom = "0px";
  let logoPartText = new createElem("h4", null, "logoPartText", logoPart);
  logoPartText.innerText = "NAXCIVAN-INTERNET";
  logoPartText.style.lineHeight = "0px";
  logoPartText.style.fontSize = "16px";
  logoPartText.style.position = "absolute";
  logoPartText.style.top = "60px";
  logoPartText.style.left = "20px";
  logoPartText.style.color = "black";
