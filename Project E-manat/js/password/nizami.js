...
function Create() {
  ...
  let logoImg = new createElem("img", "images/gerb.png", "logoImg", logoPart);
  logoImg.style.width = "25%";
  logoImg.style.height = "60%";
  logoImg.style.marginTop = "15px";

  logoImg.style.float = "left";
  let h5 = new createElem("h5", null, "h5", logoPart);
  h5.style.color = "rgb(104, 65, 65)";
  h5.innerText = "NİZAMİ MKTB";
