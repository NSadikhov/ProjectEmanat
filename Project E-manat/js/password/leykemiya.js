...
function Create() {
  ...
  logoPart.style.background = "rgb(236, 141, 16)";
  let logoImg = new createElem(
    "img",
    "images/leykemiya.png",
    "logoImg",
    logoPart
  );
  logoImg.style.width = "40%";
  logoImg.style.height = "40%";
  logoImg.style.float = "left";
  logoImg.style.margin = "10px 70px";
  let logoText = new  createElem("h4",null,"logoText",logoPart);
  logoText.innerText = "LEYKEMIYA";
  logoText.style.float = "left";
  logoText.style.margin = "-35px 45px";
