...
function Create() {
  ...
  logoPart.style.background = "rgb(172, 195, 221)";
  let logoPartText = new createElem("h4", null, "logoPartText", logoPart);
  logoPartText.innerText = "NAXCIVAN-TELEFON";
  logoPartText.style.fontSize = "18px";
  logoPartText.style.color = "rgb(54, 85, 223)";
