function azeMoment() {
  ...
  config2 = [
    {
      text: "Sığorta xidmətləri"
    },
    {
      text: "Elanlar və endirimlər"
    },
    {
      text: "Xeyriyyə və yardım"
    },
    {
      text: "Ödəmə kartları"
    },
  ...
  if (document.location.href.indexOf("index") > 0) {
  ...
  } else if (document.location.href.indexOf("provider") > 0) {
    $(".btnText")[0].innerText = "ANA SƏHİFƏ";
    if (localStorage.provider == "js/communal.js") {
      if ($(".creation")[0].src.indexOf("communal") > 0) {
        $(".textPart")[0].innerText = "KOMMUNAL ÖDƏNİŞLƏR";
        $(".h4")[0].innerText = "Kommunal ödənişlər Naxçıvan";
      }
    } else if (localStorage.provider == "js/mobile.js") {
      if ($(".creation")[0].src.indexOf("mobile") > 0) {
        $(".textPart")[0].innerText = "MOBİL OPERATORLAR";

        $(".h4")[0].innerText = "Xarici mobil operatorlar";
      }
    } else if (localStorage.provider == "js/bank.js") {
      if ($(".creation")[0].src.indexOf("bank") > 0) {
        $(".textPart")[0].innerText = "BANK XİDMƏTLƏRİ";

        $(".flexDivText")[0].innerText = "Kreditlərin sifarişi";
        $(".forwardBtnText")[0].innerText = "İRƏLİ";
        $(".backBtnText")[0].innerText = "GERİ";
      }
    } else if (localStorage.provider == "js/state.js") {
      if ($(".creation")[0].src.indexOf("state") > 0) {
        $(".textPart")[0].innerText = "DÖVLƏT VƏ BƏLƏDİYYƏ";

        $(".secondText")[0].innerText = "Bələdiyyə vergiləri və ödənişlər";
        $(".fourthText")[0].innerText = "DİN CƏRİMƏ ÖDƏNİŞLƏRİ";
        $(".fifthText")[0].innerText = "DGK CƏRİMƏ ÖDƏNİŞLƏRİ";
      }
    ...
    if (localStorage.passprovider == "js/password/azeriqaz.js") {
      ...
      if ($(".creation")[0].src.indexOf("azerisiq") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, abonent kodu daxil edin:";
      }
      ...
      if ($(".creation")[0].src.indexOf("azercell") > 0) {
        $(".label")[0].innerText =
          "Xahiş edirik, telefon nömrənizi daxil edin:";
      }
      ...
      if ($(".creation")[0].src.indexOf("megaSigorta") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, ödəniş kodunuzu daxil edin:";
      }
    } else if (localStorage.passprovider == "js/password/rahatYasam.js") {
      if ($(".creation")[0].src.indexOf("rahatYasam") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, ev nömrənizi daxil edin:";
      }
      ...
      if ($(".creation")[0].src.indexOf("unibank") > 0) {
        $(".label")[0].innerText =
          "Şəxsiyyət Vəsiqəsinin pin kodunu (Hərbi Bilet nömrəsini) daxil edin:";
      }
    } else if (localStorage.passprovider == "js/password/bankofbaku.js") {
      if ($(".creation")[0].src.indexOf("bankofbaku") > 0) {
        $(".label")[0].innerText = "Müştəri nömrənizi daxil edin:";
      }
      ...
      if ($(".creation")[0].src.indexOf("emdk") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, ərizə nömrənizi daxil edin:";
      }
    } else if (
      ...
      if ($(".creation")[0].src.indexOf("belediyyevergileri") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, ərizə nömrənizi daxil edin:";
        $(".h5")[0].innerText = "Bələdiyyə vergiləri";
      }
    ...
    } else if (localStorage.passprovider == "js/password/bakaztel.js") {
      if ($(".creation")[0].src.indexOf("bakaztel") > 0) {
        $(".label")[0].innerText = "Mobil nömrənizi daxil edin:";
      }
    } else if (localStorage.passprovider == "js/password/transeurocom.js") {
      if ($(".creation")[0].src.indexOf("transeurocom") > 0) {
        $(".label")[0].innerText = "Mobil nömrənizi daxil edin:";
      }
    } else if (localStorage.passprovider == "js/password/catel.js") {
      if ($(".creation")[0].src.indexOf("catel") > 0) {
        $(".label")[0].innerText = "Mobil nömrənizi daxil edin:";
      }
    } else if (localStorage.passprovider == "js/password/naxcivantelefon.js") {
      if ($(".creation")[0].src.indexOf("naxcivantelefon") > 0) {
        $(".label")[0].innerText = "Mobil nömrənizi daxil edin:";
      }
    } else if (localStorage.passprovider == "js/password/worldoftanks.js") {
      if ($(".creation")[0].src.indexOf("worldoftanks") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, email ünvanını daxil edin:";
      }
      ...
      if ($(".creation")[0].src.indexOf("portmanat") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, mobil nömrə və ya Portmanat kodunu daxil edin:";
      }
    } else if (localStorage.passprovider == "js/password/kassam.js") {
      if ($(".creation")[0].src.indexOf("kassam") > 0) {
        $(".label")[0].innerText =
          "Xahiş edirik, mobil nömrə və ya Portmanat kodunu daxil edin:";
      }
      ...
      if ($(".creation")[0].src.indexOf("azsigorta") > 0) {
        $(".label")[0].innerText ="Xahiş edirik, müqavilə nömrəsini daxil edin:";
      }
    } else if (localStorage.passprovider == "js/password/megasigorta.js") {
      if ($(".creation")[0].src.indexOf("megasigorta") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, ödəniş kodunu daxil edin:";
      }
      ...
      if ($(".creation")[0].src.indexOf("besmart") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, hesab nömrənizi daxil edin:"
      }
      ...
      if ($(".creation")[0].src.indexOf("umidyeri") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, mobil nömrənizi daxil edin:"
      }
      ...
      if ($(".creation")[0].src.indexOf("flo") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, sifariş kodunu daxil edin:";
      }
      ...
      if ($(".creation")[0].src.indexOf("dim") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, şəxsi kabinetin nömrəsini daxil edin:";
      }
      ...
      if ($(".creation")[0].src.indexOf("faberlic") > 0) {
        $(".label")[0].innerText = "İstifadəçi kodunu daxil edin:";
      }
      ...
      if ($(".creation")[0].src.indexOf("trips") > 0) {
        $(".label")[0].innerText = "Xahiş edirik, rezervasiya kodunu daxil edin:";
      }
    } 
  } else if (document.location.href.indexOf("paymentPart") > 0) {
    $(".btnText")[0].innerText = "ANA SƏHİFƏ";
    $(".label")[0].innerText = "ABONENT KODU";
    $(".forwardBtnText")[0].innerText = "İRƏLİ";
    
  } else if (document.location.href.indexOf("lastPart") > 0) {
    $(".btnText")[0].innerText = "ANA SƏHİFƏ";
    $(".mainText")[0].innerText ="Abonent "+localStorage.input+" tərəfindən "+localStorage.payment+" azn daxil edildi";
  }
}
